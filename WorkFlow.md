...
13. When the pull request is accepted you should go to your master branch and update it, from the main repo as follow (so that it includes the latest features and pull request as the main repo)
    ...
    git push
    ```
14. Then you should remove the feature branch that you made pull request with and got accepted
